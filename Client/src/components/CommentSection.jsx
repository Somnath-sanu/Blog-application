...
export default function CommentSection({ postId }) {
  ...
  // console.log(comments); //! Array of objects
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data) {
        ...
        setComments([data.newComment, ...comments]); //! comments = []
      }
    } catch (error) {
  ...
  const handleLike = async (commentId) => {
    try {
      ...
      console.log("LIKE COMMENTS :: ERROR ::", error);
    }
  };
  ...
  return (
    <div className="max-w-2xl mx-auto w-full p-3">
      ...
      {currentUser && (
        <form onSubmit={handleSubmit} className=" rounded-md p-3 shadow-lg">
          <Textarea
